...
в этот момент. Программа должна вывести два числа: 
количество часов (от 0 до 23) и количество минут (от 0 до 59). 
Учтите, что число n может быть больше, чем количество минут в 
сутках.
'''
#**************************************************
n = int(input())
days=n//1440
hours=(n-1440*days)//60
minutes=n-1440*days-60*hours
print(hours)
print(minutes)
